...
class NewErrorModel:
    def __init__(self, targets=None, errorFunction='MAE', non_exceedance_threshold=0, logQopt=False):
...
if __name__ == '__main__':
    ...
    error_model = Error(targets, error_function='MAE', non_exceedance_threshold=0)
